...
import cod from "../Components/Assets/cash on delivery.jpg";
  ...
  return (
    <div className='container rounded-lg mx-auto px-4 mt-40'>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-4 border border-gray-200 p-8 rounded-md'>
            ...
            <div className='flex flex-col gap-1'>
              <div className='font-semibold mb-4'>Payment Options</div>
              <div className='flex justify-between'>
                <img className='w-20 cursor-pointer' src={bank_logo} alt="bank-logo" />
                <img className='w-20 cursor-pointer' src={paypal} alt="paypal-logo" />
                <img className='w-20 cursor-pointer' src={cod} alt="cod-logo" />
              </div>
            </div>
            <Link to='/cart'>
      ...
      <div className='flex flex-col gap-4 mt-12  py-4'>
          ...
          <div className='flex'>
                <input
                  className='focus:outline-none focus:border-blue-500 border-2 px-4 sm:px-6 py-2 rounded-md'
                 type="text"
                  placeholder='Enter promo code' />
                <button
                 className='bg-gray-700 text-white border px-2 sm:px-4 py-2 rounded-md font-bold border-gray-700 
                  hover:text-gray-700 hover:bg-transparent transform transition duration-500'>
                  Apply</button>
          </div>
      </div>
    </div>
